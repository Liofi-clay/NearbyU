...
<body>
        ...
        <div class="container p-2">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item me-4">
                        <a class="btn btn-dark fw-medium" href="#" role="button">Sign In</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container pt-5">
        <div class="row">
            <div class="col-md-6">
                <img src="assets/desk2.jpg" class="img-fluid rounded" alt="...">
            </div>
            <div class="col-md-6 ps-5">
                <h4 class="fw-semibold">Collaborative Desk</h4>
                <p class="card-text">Ruangan Privat Untuk Kegiatan Skala Besar</p>
                <p class="fw-medium">30 Orang</p>
                <p class="fs-5 fw-semibold">IDR 700000/4 Jam</p>
                <p>Desain meja fleksibel untuk kerja kelompok dan individu dengan sekat yang dapat dibuka untuk meningkatkan produktivitas kerja tugas kelompok.</p>
                <h5>Our Facility</h5>
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 text-align mb-4">
                            <i class="fa-solid fa-tv" style="color:#03829E"></i>
                            <span class="feature-text">Proyektor</span>
                        </div>
            ...
            <div class="col-sm-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="detail Individual desk.html" class="btn btn-primary">Learn More</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Gorup Desk</h5>
